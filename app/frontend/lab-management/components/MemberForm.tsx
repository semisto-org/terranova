                    ...
                    <div className="relative flex-shrink-0">
                      {avatarPreview ? (
                        <img
                          src={avatarPreview}
                          alt="Avatar"
                          className="w-20 h-20 rounded-xl object-cover border-2 border-stone-200 ring-2 ring-stone-100"
                        />
                      ) : (
                        <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#5B5781]/20 to-[#5B5781]/5 border-2 border-dashed border-stone-300 flex items-center justify-center text-stone-400">
                      ...
                      <div className="flex gap-2">
                        ...
                        {avatarPreview && (
                          <button
                            ...
                            className="px-3 py-1.5 text-sm font-medium text-red-600 rounded-lg border border-red-200 hover:bg-red-50 transition-colors cursor-pointer"
                          >
                            Supprimer
                          </button>
                        )}
                      ...
                      return (
                        <button
                          ...
                          className={`
                            ...
                            ${
                              isSelected
                                ? 'border-[#5B5781] bg-[#5B5781]/5 shadow-sm'
                    ...
                    <div className="relative flex items-center">
                      ...
                      <div
                        className={`
                          ...
                          ${isAdmin ? 'bg-[#5B5781]' : 'bg-stone-300'}
                        `}
                      >
                        <div
                          className={`

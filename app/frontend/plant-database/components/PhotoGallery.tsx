...
export function PhotoGallery({ photos, contributors, onContributorSelect }: PhotoGalleryProps) {
  ...
  if (photos.length === 0) {
    return (
      <div className="aspect-[4/3] bg-gradient-to-br from-stone-100 to-stone-200 rounded-2xl flex items-center justify-center">
          ...
          {photos.map((photo, index) => (
            <button
              ...
              className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden transition-all ${
                index === selectedIndex
                  ? 'ring-2 ring-[#AFBD00] ring-offset-2 ring-offset-white'

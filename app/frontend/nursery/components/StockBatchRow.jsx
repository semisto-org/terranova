    ...
    <div className="group relative">
      ...
      <div className="hidden md:grid md:grid-cols-12 gap-4 items-center py-4 px-4 border-b border-stone-200 hover:bg-stone-50 transition-colors">
        <div className="col-span-3">
          <div className="font-medium text-stone-900">{batch.speciesName}</div>
        ...
        <div className="col-span-1 flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <button onClick={onView} className="p-1.5 rounded-md text-stone-500 hover:text-stone-700 hover:bg-stone-100 transition-colors"><Eye className="w-4 h-4" /></button>
      ...
      <div className="md:hidden p-4 border border-stone-200 rounded-lg bg-white hover:shadow-md transition-shadow">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <div className="font-medium text-stone-900 mb-1">{batch.speciesName}</div>
            {batch.varietyName && <div className="text-sm text-stone-600 mb-2">{batch.varietyName}</div>}
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <div>
            ...
            <div className="text-sm font-medium text-stone-900">{batch.availableQuantity} disponible</div>

...
export function StockBatchForm({ batch, nurseries, containers, onSave, onCancel }) {
  ...
  const inputClass = "w-full px-3 py-2 border border-stone-300 rounded-md bg-white text-stone-900 focus:outline-none focus:ring-2 focus:ring-[#EF9B0D] focus:border-transparent"

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-lg shadow-xl border border-stone-200">
        <div className="sticky top-0 z-10 flex items-center justify-between p-6 border-b border-stone-200 bg-white">
          <h2 className="text-xl font-semibold text-stone-900" style={{ fontFamily: 'Sole Serif Small, serif' }}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-stone-700 uppercase tracking-wide">Informations de base</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Pépinière <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Contenant <span className="text-red-500">*</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Espèce <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Variété <span className="text-xs text-stone-500">(optionnel)</span></label>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-stone-700 uppercase tracking-wide">Quantités</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Quantité totale <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Disponible <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Réservé</label>
                <input type="number" min="0" value={formData.reservedQuantity} readOnly className={`${inputClass} bg-stone-50`} />
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-stone-700 uppercase tracking-wide">Détails</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Date de semis</label>
                <input type="date" value={formData.sowingDate} onChange={(e) => setFormData({ ...formData, sowingDate: e.target.value })} className={inputClass} />
              </div>
              <div>
                <label className="block text-sm font-medium text-stone-700 mb-1">Stade de développement</label>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-stone-700 uppercase tracking-wide">Prix</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>

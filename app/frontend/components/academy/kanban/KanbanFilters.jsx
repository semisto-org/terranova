...
const SORT_OPTIONS = [
  { id: 'priority', label: 'Priorite operationnelle' },
  { id: 'date_asc', label: 'Date (proche → loin)' },
  { id: 'date_desc', label: 'Date (loin → proche)' },
  { id: 'completeness_desc', label: 'Completude (haute → basse)' },
  { id: 'completeness_asc', label: 'Completude (basse → haute)' },
  { id: 'updated_desc', label: 'Derniere mise a jour' },
]
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            ...
            className="w-full rounded-lg border border-stone-200 bg-white pl-9 pr-3 py-2 text-sm outline-none focus:border-[#B01A19] focus:ring-1 focus:ring-[#B01A19]/20 transition-all"
          />
        </div>
        ...
        {/* Sort */}
        <label className="inline-flex items-center gap-1.5 text-xs text-stone-500 ml-auto">
          <ArrowUpDown className="w-3.5 h-3.5" />
          <select
            value={sortBy}
            onChange={(e) => onSortChange(e.target.value)}
            className="rounded-md border border-stone-200 bg-white px-2 py-1.5 text-xs text-stone-700 outline-none focus:border-[#B01A19]"
          >

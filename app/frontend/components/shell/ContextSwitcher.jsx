...
const POLES = [
  { id: 'lab', label: 'Gestion du Lab', path: '/lab', accent: '#5B5781', bg: '#c8bfd2' },
  { id: 'design', label: 'Design Studio', path: '/design', accent: '#AFBD00', bg: '#e1e6d8' },
  { id: 'academy', label: 'Academy', path: '/academy', accent: '#B01A19', bg: '#eac7b8' },
  { id: 'nursery', label: 'Nursery', path: '/nursery', accent: '#EF9B0D', bg: '#fbe6c3' },

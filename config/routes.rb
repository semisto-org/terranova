Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get "design/:project_id/observation-notes", to: "design_studio#observation_notes"
      post "design/:project_id/observation-notes", to: "design_studio#create_observation_note"
      delete "design/observation-notes/:note_id", to: "design_studio#destroy_observation_note"
      get "design/:project_id/interview", to: "design_studio#interview"
      patch "design/:project_id/interview", to: "design_studio#upsert_interview"
      post "design/:project_id/interview/audio", to: "design_studio#upload_interview_audio"
      get "design/:project_id/releve", to: "design_studio#releve"
      post "design/:project_id/releve/plan", to: "design_studio#upload_releve_plan"
